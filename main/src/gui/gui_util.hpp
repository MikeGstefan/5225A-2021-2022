...
Text mot_text_1 (65, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[0]));
Text mot_text_2 (180, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[1]));
Text mot_text_3 (295, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[2]));
Text mot_text_4 (410, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[3]));
Text mot_text_5 (65, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[4]));
Text mot_text_6 (180, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[5]));
Text mot_text_7 (295, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[6]));
Text mot_text_8 (410, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[7]));
