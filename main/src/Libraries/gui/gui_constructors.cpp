...
_Text rings(MID_X, 50, Style::CENTRE, TEXT_LARGE, intake_test, "Ring Count: %d", ring_count);
...
_Text elastic_up (MID_X, 160, Style::CENTRE, TEXT_SMALL, elastic, "Up Time: %d", elastic_up_time);
_Text elastic_down(MID_X, 180, Style::CENTRE, TEXT_SMALL, elastic, "Down Time: %d", elastic_down_time);
...
_Text tuning_instructions_1(MID_X, 35, Style::CENTRE, TEXT_SMALL, tuning, "Press your desired tracking test");
_Text tuning_instructions_2(MID_X, 50, Style::CENTRE, TEXT_SMALL, tuning, "and follow the terminal for instructions");
...
_Text pneum_text_1 (125, 50, Style::CENTRE, TEXT_SMALL, pneumatic, "PORT G");
_Text pneum_text_2 (350, 50, Style::CENTRE, TEXT_SMALL, pneumatic, "PORT G - no config for 2");
...
_Text encAB (85, 50, Style::CENTRE, TEXT_SMALL, encoders, "AB Encoder:%d", left_enc);
_Text encCD (240, 50, Style::CENTRE, TEXT_SMALL, encoders, "CD Encoder:%d", right_enc);
_Text encEF (395, 50, Style::CENTRE, TEXT_SMALL, encoders, "EF Encoder:%d", back_enc);
...
Button resAllEnc (240, 180, 200, 30, Style::CENTRE, Button::SINGLE, encoders, "Reset All");

Page motor ("Motor Control");
Slider mot_speed (MID_X, 60, 180 , 15, Style::CENTRE, Slider::HORIZONTAL, -127, 127, motor, "Speed");
_Text mot_text_1 (65, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[0]));
_Text mot_text_2 (180, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[1]));
_Text mot_text_3 (295, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[2]));
_Text mot_text_4 (410, 115, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[3]));
_Text mot_text_5 (65, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[4]));
_Text mot_text_6 (180, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[5]));
_Text mot_text_7 (295, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[6]));
_Text mot_text_8 (410, 180, Style::CENTRE, TEXT_SMALL, motor, "Port %s", std::get<4>(motor_ports[7]));
