...
void move_on_line(void* params){
  ...
  double kp_lx =21.0, kp_ly =7.0, kp_dx = 21.0, kp_dy = 7.5, kp_a = 50.0, ki_lx = 0.0, ki_ly = 0.0, ki_dx = 0.0, ki_dy = 0.0, ki_a = 0.0, kd_lx = 0.0, kd_ly = 0.0, kd_dx = 0.0, kd_dy = 0.0, kd_a = 0.0;
