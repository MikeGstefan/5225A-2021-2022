...
void find_arm_angles(Vector2D target){
    ...
    double bottom_arm_len = 13.0, top_arm_len = 11.0;
    ...
    double offset_h = 16.5 + dist_between_axles; // height of arm + wheel_radius + dist_between_axles
    target.y -= offset_h;
    ...
    // bottom_arm_angle = target_angle + B;
    // top_arm_angle = 2 * M_PI - C - bottom_arm_angle + top_arm_offset_a;
    // bottom_arm_angle += bottom_arm_offset_a;
    // printf("bottom_arm_angle: %lf\n", rad_to_deg(bottom_arm_angle));
    // printf("top_arm_angle: %lf\n", rad_to_deg(top_arm_angle));
    ...
    top_arm_angle *= top_arm_ratio;

    printf("bottom_arm_angle: %lf\n", rad_to_deg(bottom_arm_angle));
    printf("top_arm_angle: %lf\n", rad_to_deg(top_arm_angle));

    f_bar.move_absolute(rad_to_deg(bottom_arm_angle), 80);
    waitUntil(f_bar.get_position() / 7.0 > 50);
    c_bar.move_absolute(rad_to_deg(top_arm_angle), 80);
}
