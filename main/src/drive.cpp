...
void Drivebase::handle_input(){
  ...
  tracking.power_x = master.get_analog(drivers[cur_driver].joy_sticks[0]);
  tracking.power_y = master.get_analog(drivers[cur_driver].joy_sticks[1]);
  tracking.power_a = master.get_analog(drivers[cur_driver].joy_sticks[2]);
