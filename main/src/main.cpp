...
//   drivebase.brake();
  ...
  // move_stop();
  // drivebase.brake();
  int delta_time = millis();
    skills();
  skills_t.print("Time after 1: %d\n", millis() - time);
  skills_t.print("Time 1 took: %d\n", millis() - delta_time);
  delta_time =millis() - time;
  skills2();
  skills_t.print("Time after 2: %d\n", millis() - time);
  skills_t.print("Time 2 took: %d\n", millis() - delta_time);
  delta_time =millis() - time;
  skills3();
  skills_t.print("Time after 3: %d\n", millis() - time);
  skills_t.print("Time 3 took: %d\n", millis() - delta_time);
  delta_time =millis() - time;
  skills4();
  skills_t.print("Time after 4: %d\n", millis() - time);
  skills_t.print("Time 4 took: %d\n", millis() - delta_time);
  delta_time =millis() - time;
  skills_park();
  master.print(0,0, "FULL : %d", millis()- time);
  skills_t.print("FULL : %d", millis()- time);
  skills_t.print("Time park took: %d\n", millis() - delta_time);
  delta_time =millis() - time;
  master.print(0,0, "FULL : %D", millis()- time);
  while(true)delay(10);
