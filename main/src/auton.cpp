...
void skills(){ 
    ...
    move_start(move_types::point, point_params(polar_to_vector_point(110.0, 14.75, 17.5, 45.0, -135.0), 127.0, false, 1.0, false), true);
    ...
    move_start(move_types::turn_point, turn_point_params({108.0, 60.0}), true);
	move_start(move_types::point, point_params({110.0, 60.0, 0.0}, 127.0, false, 0.0, false),true);
    move_start(move_types::point, point_params({110.0, 80.0, 0.0}, 127.0, false, 0.0, false),true);
    move_start(move_types::tank_arc, tank_arc_params({110.0, 84.0},{80.0, 96.0, -90.0}, 127.0), true);
    // move_start(move_types::point, point_params({60.0, 96.0, -90.0}, 80.0, false, 0.0, true), true);
    // move_start(move_types::point, point_params({60.0, 108.0, -90.0}, 80.0, false, 0.0, true), true);
